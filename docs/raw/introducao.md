...
Source: https://focusnfe.com.br/doc/#introducao

Introdução


  Reforma Tributária: Acesse nossos Guides e veja o que muda na integração com a API.
  Aviso: Esta documentação está em migração, consulte a nova documentação em progresso.
